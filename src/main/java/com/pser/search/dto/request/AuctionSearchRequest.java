...
public class AuctionSearchRequest extends SearchQuery {
    ...
    private Integer depositPriceGte;

    private Integer depositPriceLte;
    ...
    @Builder
    public AuctionSearchRequest(String keyword, Double scoreAfter, Long idAfter, LocalDateTime createdAfter,
